...
PFNGLXENUMERATEVIDEOCAPTUREDEVICESNVPROC
    glad_glXEnumerateVideoCaptureDevicesNV = NULL;
...
PFNGLXGETCURRENTASSOCIATEDCONTEXTAMDPROC
    glad_glXGetCurrentAssociatedContextAMD = NULL;
...
static void glad_glx_load_GLX_AMD_gpu_association(GLADuserptrloadfunc load,
                                                  void *userptr) {
  if (!GLAD_GLX_AMD_gpu_association)
    return;
  glad_glXBlitContextFramebufferAMD = (PFNGLXBLITCONTEXTFRAMEBUFFERAMDPROC)load(
...
static void glad_glx_load_GLX_ARB_create_context(GLADuserptrloadfunc load,
                                                 void *userptr) {
...
static void glad_glx_load_GLX_ARB_get_proc_address(GLADuserptrloadfunc load,
                                                   void *userptr) {
...
static void glad_glx_load_GLX_EXT_import_context(GLADuserptrloadfunc load,
                                                 void *userptr) {
  ...
  glad_glXGetCurrentDisplayEXT =
      (PFNGLXGETCURRENTDISPLAYEXTPROC)load(userptr, "glXGetCurrentDisplayEXT");
...
static void glad_glx_load_GLX_EXT_swap_control(GLADuserptrloadfunc load,
                                               void *userptr) {
...
static void glad_glx_load_GLX_EXT_texture_from_pixmap(GLADuserptrloadfunc load,
                                                      void *userptr) {
...
static void glad_glx_load_GLX_MESA_agp_offset(GLADuserptrloadfunc load,
                                              void *userptr) {
...
static void glad_glx_load_GLX_MESA_copy_sub_buffer(GLADuserptrloadfunc load,
                                                   void *userptr) {
...
static void glad_glx_load_GLX_MESA_pixmap_colormap(GLADuserptrloadfunc load,
                                                   void *userptr) {
...
static void glad_glx_load_GLX_MESA_release_buffers(GLADuserptrloadfunc load,
                                                   void *userptr) {
...
static void glad_glx_load_GLX_MESA_set_3dfx_mode(GLADuserptrloadfunc load,
                                                 void *userptr) {
...
static void glad_glx_load_GLX_MESA_swap_control(GLADuserptrloadfunc load,
                                                void *userptr) {
...
static void glad_glx_load_GLX_NV_copy_buffer(GLADuserptrloadfunc load,
                                             void *userptr) {
...
static void glad_glx_load_GLX_NV_copy_image(GLADuserptrloadfunc load,
                                            void *userptr) {
...
static void glad_glx_load_GLX_NV_delay_before_swap(GLADuserptrloadfunc load,
                                                   void *userptr) {
...
static void glad_glx_load_GLX_NV_present_video(GLADuserptrloadfunc load,
                                               void *userptr) {
...
static void glad_glx_load_GLX_NV_swap_group(GLADuserptrloadfunc load,
                                            void *userptr) {
  ...
  glad_glXQueryMaxSwapGroupsNV =
      (PFNGLXQUERYMAXSWAPGROUPSNVPROC)load(userptr, "glXQueryMaxSwapGroupsNV");
...
static void glad_glx_load_GLX_NV_video_capture(GLADuserptrloadfunc load,
                                               void *userptr) {
  ...
  glad_glXQueryVideoCaptureDeviceNV = (PFNGLXQUERYVIDEOCAPTUREDEVICENVPROC)load(
...
static void glad_glx_load_GLX_NV_video_out(GLADuserptrloadfunc load,
                                           void *userptr) {
  ...
  glad_glXReleaseVideoDeviceNV =
      (PFNGLXRELEASEVIDEODEVICENVPROC)load(userptr, "glXReleaseVideoDeviceNV");
  glad_glXReleaseVideoImageNV =
      (PFNGLXRELEASEVIDEOIMAGENVPROC)load(userptr, "glXReleaseVideoImageNV");
  glad_glXSendPbufferToVideoNV =
      (PFNGLXSENDPBUFFERTOVIDEONVPROC)load(userptr, "glXSendPbufferToVideoNV");
}
static void glad_glx_load_GLX_OML_sync_control(GLADuserptrloadfunc load,
                                               void *userptr) {
...
static void glad_glx_load_GLX_SGIX_fbconfig(GLADuserptrloadfunc load,
                                            void *userptr) {
  ...
  glad_glXGetFBConfigFromVisualSGIX = (PFNGLXGETFBCONFIGFROMVISUALSGIXPROC)load(
      userptr, "glXGetFBConfigFromVisualSGIX");
  glad_glXGetVisualFromFBConfigSGIX = (PFNGLXGETVISUALFROMFBCONFIGSGIXPROC)load(
      userptr, "glXGetVisualFromFBConfigSGIX");
}
static void glad_glx_load_GLX_SGIX_hyperpipe(GLADuserptrloadfunc load,
                                             void *userptr) {
  ...
  glad_glXQueryHyperpipeNetworkSGIX = (PFNGLXQUERYHYPERPIPENETWORKSGIXPROC)load(
      userptr, "glXQueryHyperpipeNetworkSGIX");
}
static void glad_glx_load_GLX_SGIX_pbuffer(GLADuserptrloadfunc load,
                                           void *userptr) {
  if (!GLAD_GLX_SGIX_pbuffer)
    return;
  glad_glXCreateGLXPbufferSGIX =
...
static void glad_glx_load_GLX_SGIX_swap_barrier(GLADuserptrloadfunc load,
                                                void *userptr) {
...
static void glad_glx_load_GLX_SGIX_swap_group(GLADuserptrloadfunc load,
                                              void *userptr) {
...
static void glad_glx_load_GLX_SGIX_video_resize(GLADuserptrloadfunc load,
                                                void *userptr) {
  ...
  glad_glXQueryChannelRectSGIX =
      (PFNGLXQUERYCHANNELRECTSGIXPROC)load(userptr, "glXQueryChannelRectSGIX");
}
static void glad_glx_load_GLX_SGI_cushion(GLADuserptrloadfunc load,
                                          void *userptr) {
  if (!GLAD_GLX_SGI_cushion)
    return;
  glad_glXCushionSGI = (PFNGLXCUSHIONSGIPROC)load(userptr, "glXCushionSGI");
}
static void glad_glx_load_GLX_SGI_make_current_read(GLADuserptrloadfunc load,
                                                    void *userptr) {
  if (!GLAD_GLX_SGI_make_current_read)
    return;
  glad_glXGetCurrentReadDrawableSGI = (PFNGLXGETCURRENTREADDRAWABLESGIPROC)load(
...
static void glad_glx_load_GLX_SGI_video_sync(GLADuserptrloadfunc load,
                                             void *userptr) {
...
static int glad_glx_has_extension(X::Display *display, int screen,
                                  const char *ext) {
...
static int glad_glx_find_extensions(X::Display *display, int screen) {
  ...
  GLAD_GLX_ARB_context_flush_control =
      glad_glx_has_extension(display, screen, "GLX_ARB_context_flush_control");
  ...
  GLAD_GLX_EXT_fbconfig_packed_float =
      glad_glx_has_extension(display, screen, "GLX_EXT_fbconfig_packed_float");
  ...
  GLAD_GLX_SUN_get_transparent_index =
      glad_glx_has_extension(display, screen, "GLX_SUN_get_transparent_index");
  return 1;
}

static int glad_glx_find_core_glx(X::Display **display, int *screen) {
  int major = 0, minor = 0;
  if (*display == NULL) {
    ...
    *screen = X::ScreenNumberOfScreen(X::DefaultScreenOfDisplay(*display));
#endif
  }
...
int gladLoadGLXUserPtr(X::Display *display, int screen, GLADuserptrloadfunc load,
                       void *userptr) {
  int version;
...
int gladLoadGLX(X::Display *display, int screen, GLADloadfunc load) {
...
int gladLoaderLoadGLX(X::Display *display, int screen) {
  int version = 0;
  void *handle = NULL;
  int did_load = 0;
