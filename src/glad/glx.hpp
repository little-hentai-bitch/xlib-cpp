/**
 * Loader generated by glad 2.0.4 on Sun Nov 19 13:43:45 2023
 *
...
typedef X::XID GLXFBConfigID;
typedef struct __GLXFBConfigRec *GLXFBConfig;
typedef X::XID GLXContextID;
typedef struct __GLXcontextRec *GLXContext;
typedef X::XID GLXPixmap;
typedef X::XID GLXDrawable;
typedef X::XID GLXWindow;
typedef X::XID GLXPbuffer;
typedef void(GLAD_API_PTR *__GLXextFuncPtr)(void);
typedef X::XID GLXVideoCaptureDeviceNV;
typedef unsigned int GLXVideoDeviceNV;
typedef X::XID GLXVideoSourceSGIX;
typedef X::XID GLXFBConfigIDSGIX;
typedef struct __GLXFBConfigRec *GLXFBConfigSGIX;
typedef X::XID GLXPbufferSGIX;
typedef struct {
  ...
  GLXDrawable drawable;     /* X::XID of Drawable */
...
typedef struct {
  ...
  X::Display *display;  /* X::Display the event was read from */
  GLXDrawable
...
typedef int(GLAD_API_PTR *PFNGLXBINDCHANNELTOWINDOWSGIXPROC)(
    X::Display *display, int screen, int channel, X::Window window);
typedef int(GLAD_API_PTR *PFNGLXBINDHYPERPIPESGIXPROC)(X::Display *dpy,
                                                       int hpId);
typedef bool(GLAD_API_PTR *PFNGLXBINDSWAPBARRIERNVPROC)(X::Display *dpy,
                                                        GLuint group,
                                                        GLuint barrier);
typedef void(GLAD_API_PTR *PFNGLXBINDSWAPBARRIERSGIXPROC)(X::Display *dpy,
                                                          GLXDrawable drawable,
                                                          int barrier);
typedef void(GLAD_API_PTR *PFNGLXBINDTEXIMAGEEXTPROC)(X::Display *dpy,
                                                      GLXDrawable drawable,
                                                      int buffer,
                                                      const int *attrib_list);
typedef int(GLAD_API_PTR *PFNGLXBINDVIDEOCAPTUREDEVICENVPROC)(
    X::Display *dpy, unsigned int video_capture_slot,
    GLXVideoCaptureDeviceNV device);
typedef int(GLAD_API_PTR *PFNGLXBINDVIDEODEVICENVPROC)(
    X::Display *dpy, unsigned int video_slot, unsigned int video_device,
    const int *attrib_list);
typedef int(GLAD_API_PTR *PFNGLXBINDVIDEOIMAGENVPROC)(
    X::Display *dpy, GLXVideoDeviceNV VideoDevice, GLXPbuffer pbuf,
    int iVideoBuffer);
typedef void(GLAD_API_PTR *PFNGLXBLITCONTEXTFRAMEBUFFERAMDPROC)(
    ...
    GLenum filter);
typedef int(GLAD_API_PTR *PFNGLXCHANNELRECTSGIXPROC)(X::Display *display,
                                                     int screen, int channel,
                                                     int x, int y, int w,
                                                     int h);
typedef int(GLAD_API_PTR *PFNGLXCHANNELRECTSYNCSGIXPROC)(X::Display *display,
                                                         int screen,
                                                         int channel,
                                                         GLenum synctype);
typedef GLXFBConfig *(GLAD_API_PTR *PFNGLXCHOOSEFBCONFIGPROC)(
    X::Display *dpy, int screen, const int *attrib_list, int *nelements);
typedef GLXFBConfigSGIX *(GLAD_API_PTR *PFNGLXCHOOSEFBCONFIGSGIXPROC)(
    X::Display *dpy, int screen, int *attrib_list, int *nelements);
typedef X::XVisualInfo *(GLAD_API_PTR *PFNGLXCHOOSEVISUALPROC)(X::Display *dpy,
                                                               int screen,
                                                               int *attribList);
typedef void(GLAD_API_PTR *PFNGLXCOPYBUFFERSUBDATANVPROC)(
    X::Display *dpy, GLXContext readCtx, GLXContext writeCtx, GLenum readTarget,
    GLenum writeTarget, GLintptr readOffset, GLintptr writeOffset,
    GLsizeiptr size);
typedef void(GLAD_API_PTR *PFNGLXCOPYCONTEXTPROC)(X::Display *dpy,
                                                  GLXContext src,
                                                  GLXContext dst,
                                                  unsigned long mask);
typedef void(GLAD_API_PTR *PFNGLXCOPYIMAGESUBDATANVPROC)(
    X::Display *dpy, GLXContext srcCtx, GLuint srcName, GLenum srcTarget,
...
typedef void(GLAD_API_PTR *PFNGLXCOPYSUBBUFFERMESAPROC)(X::Display *dpy,
                                                        GLXDrawable drawable,
...
typedef GLXPixmap(GLAD_API_PTR *PFNGLXCREATEGLXPIXMAPWITHCONFIGSGIXPROC)(
    X::Display *dpy, GLXFBConfigSGIX config, X::Pixmap pixmap);
typedef GLXContext(GLAD_API_PTR *PFNGLXCREATENEWCONTEXTPROC)(
    X::Display *dpy, GLXFBConfig config, int render_type, GLXContext share_list,
    bool direct);
typedef GLXPbuffer(GLAD_API_PTR *PFNGLXCREATEPBUFFERPROC)(
    X::Display *dpy, GLXFBConfig config, const int *attrib_list);
typedef GLXPixmap(GLAD_API_PTR *PFNGLXCREATEPIXMAPPROC)(X::Display *dpy,
                                                        GLXFBConfig config,
                                                        X::Pixmap pixmap,
                                                        const int *attrib_list);
typedef GLXWindow(GLAD_API_PTR *PFNGLXCREATEWINDOWPROC)(X::Display *dpy,
                                                        GLXFBConfig config,
                                                        X::Window win,
                                                        const int *attrib_list);
typedef void(GLAD_API_PTR *PFNGLXCUSHIONSGIPROC)(X::Display *dpy,
                                                 X::Window window,
                                                 float cushion);
typedef bool(GLAD_API_PTR *PFNGLXDELAYBEFORESWAPNVPROC)(X::Display *dpy,
                                                        GLXDrawable drawable,
                                                        GLfloat seconds);
typedef bool(GLAD_API_PTR *PFNGLXDELETEASSOCIATEDCONTEXTAMDPROC)(
    GLXContext ctx);
typedef void(GLAD_API_PTR *PFNGLXDESTROYCONTEXTPROC)(X::Display *dpy,
                                                     GLXContext ctx);
typedef void(GLAD_API_PTR *PFNGLXDESTROYGLXPBUFFERSGIXPROC)(
    X::Display *dpy, GLXPbufferSGIX pbuf);
typedef void(GLAD_API_PTR *PFNGLXDESTROYGLXPIXMAPPROC)(X::Display *dpy,
                                                       GLXPixmap pixmap);
typedef int(GLAD_API_PTR *PFNGLXDESTROYHYPERPIPECONFIGSGIXPROC)(X::Display *dpy,
                                                                int hpId);
typedef void(GLAD_API_PTR *PFNGLXDESTROYPBUFFERPROC)(X::Display *dpy,
                                                     GLXPbuffer pbuf);
typedef void(GLAD_API_PTR *PFNGLXDESTROYPIXMAPPROC)(X::Display *dpy,
                                                    GLXPixmap pixmap);
typedef void(GLAD_API_PTR *PFNGLXDESTROYWINDOWPROC)(X::Display *dpy,
                                                    GLXWindow win);
typedef GLXVideoCaptureDeviceNV *(
    GLAD_API_PTR *PFNGLXENUMERATEVIDEOCAPTUREDEVICESNVPROC)(X::Display *dpy,
                                                            int screen,
                                                            int *nelements);
typedef unsigned int *(GLAD_API_PTR *PFNGLXENUMERATEVIDEODEVICESNVPROC)(
    X::Display *dpy, int screen, int *nelements);
typedef void(GLAD_API_PTR *PFNGLXFREECONTEXTEXTPROC)(X::Display *dpy,
                                                     GLXContext context);
typedef unsigned int(GLAD_API_PTR *PFNGLXGETAGPOFFSETMESAPROC)(
    const void *pointer);
typedef const char *(GLAD_API_PTR *PFNGLXGETCLIENTSTRINGPROC)(X::Display *dpy,
                                                              int name);
typedef int(GLAD_API_PTR *PFNGLXGETCONFIGPROC)(X::Display *dpy,
                                               X::XVisualInfo *visual,
...
typedef X::Display *(GLAD_API_PTR *PFNGLXGETCURRENTDISPLAYPROC)(void);
typedef X::Display *(GLAD_API_PTR *PFNGLXGETCURRENTDISPLAYEXTPROC)(void);
...
typedef int(GLAD_API_PTR *PFNGLXGETFBCONFIGATTRIBPROC)(X::Display *dpy,
                                                       GLXFBConfig config,
                                                       int attribute,
                                                       int *value);
typedef int(GLAD_API_PTR *PFNGLXGETFBCONFIGATTRIBSGIXPROC)(
    X::Display *dpy, GLXFBConfigSGIX config, int attribute, int *value);
typedef GLXFBConfigSGIX(GLAD_API_PTR *PFNGLXGETFBCONFIGFROMVISUALSGIXPROC)(
    X::Display *dpy, X::XVisualInfo *vis);
typedef GLXFBConfig *(GLAD_API_PTR *PFNGLXGETFBCONFIGSPROC)(X::Display *dpy,
                                                            int screen,
                                                            int *nelements);
...
typedef int(GLAD_API_PTR *PFNGLXGETGPUINFOAMDPROC)(unsigned int id,
                                                   ...
                                                   unsigned int size,
                                                   void *data);
typedef bool(GLAD_API_PTR *PFNGLXGETMSCRATEOMLPROC)(X::Display *dpy,
                                                    GLXDrawable drawable,
                                                    int32_t *numerator,
                                                    int32_t *denominator);
...
typedef void(GLAD_API_PTR *PFNGLXGETSELECTEDEVENTPROC)(
    X::Display *dpy, GLXDrawable draw, unsigned long *event_mask);
typedef void(GLAD_API_PTR *PFNGLXGETSELECTEDEVENTSGIXPROC)(X::Display *dpy,
                                                           GLXDrawable drawable,
                                                           unsigned long *mask);
typedef int(GLAD_API_PTR *PFNGLXGETSWAPINTERVALMESAPROC)(void);
typedef bool(GLAD_API_PTR *PFNGLXGETSYNCVALUESOMLPROC)(X::Display *dpy,
                                                       GLXDrawable drawable,
                                                       int64_t *ust,
                                                       int64_t *msc,
                                                       int64_t *sbc);
typedef X::Status(GLAD_API_PTR *PFNGLXGETTRANSPARENTINDEXSUNPROC)(
    X::Display *dpy, X::Window overlay, X::Window underlay,
    unsigned long *pTransparentIndex);
typedef int(GLAD_API_PTR *PFNGLXGETVIDEODEVICENVPROC)(
    X::Display *dpy, int screen, int numVideoDevices,
    GLXVideoDeviceNV *pVideoDevice);
typedef int(GLAD_API_PTR *PFNGLXGETVIDEOINFONVPROC)(
    X::Display *dpy, int screen, GLXVideoDeviceNV VideoDevice,
    unsigned long *pulCounterOutputPbuffer,
    unsigned long *pulCounterOutputVideo);
typedef int(GLAD_API_PTR *PFNGLXGETVIDEOSYNCSGIPROC)(unsigned int *count);
typedef X::XVisualInfo *(GLAD_API_PTR *PFNGLXGETVISUALFROMFBCONFIGPROC)(
    X::Display *dpy, GLXFBConfig config);
typedef X::XVisualInfo *(GLAD_API_PTR *PFNGLXGETVISUALFROMFBCONFIGSGIXPROC)(
    X::Display *dpy, GLXFBConfigSGIX config);
typedef int(GLAD_API_PTR *PFNGLXHYPERPIPEATTRIBSGIXPROC)(X::Display *dpy,
                                                         int timeSlice,
                                                         int attrib, int size,
                                                         void *attribList);
typedef int(GLAD_API_PTR *PFNGLXHYPERPIPECONFIGSGIXPROC)(
    X::Display *dpy, int networkId, int npipes, GLXHyperpipeConfigSGIX *cfg,
    int *hpId);
typedef GLXContext(GLAD_API_PTR *PFNGLXIMPORTCONTEXTEXTPROC)(
    X::Display *dpy, GLXContextID contextID);
typedef bool(GLAD_API_PTR *PFNGLXISDIRECTPROC)(X::Display *dpy, GLXContext ctx);
typedef bool(GLAD_API_PTR *PFNGLXJOINSWAPGROUPNVPROC)(X::Display *dpy,
                                                      GLXDrawable drawable,
                                                      GLuint group);
typedef void(GLAD_API_PTR *PFNGLXJOINSWAPGROUPSGIXPROC)(X::Display *dpy,
                                                        GLXDrawable drawable,
                                                        GLXDrawable member);
typedef void(GLAD_API_PTR *PFNGLXLOCKVIDEOCAPTUREDEVICENVPROC)(
    X::Display *dpy, GLXVideoCaptureDeviceNV device);
typedef bool(GLAD_API_PTR *PFNGLXMAKEASSOCIATEDCONTEXTCURRENTAMDPROC)(
    GLXContext ctx);
typedef bool(GLAD_API_PTR *PFNGLXMAKECONTEXTCURRENTPROC)(X::Display *dpy,
                                                         GLXDrawable draw,
                                                         GLXDrawable read,
                                                         GLXContext ctx);
typedef bool(GLAD_API_PTR *PFNGLXMAKECURRENTPROC)(X::Display *dpy,
                                                  GLXDrawable drawable,
                                                  GLXContext ctx);
typedef bool(GLAD_API_PTR *PFNGLXMAKECURRENTREADSGIPROC)(X::Display *dpy,
                                                         GLXDrawable draw,
                                                         GLXDrawable read,
                                                         GLXContext ctx);
typedef void(GLAD_API_PTR *PFNGLXNAMEDCOPYBUFFERSUBDATANVPROC)(
    X::Display *dpy, GLXContext readCtx, GLXContext writeCtx, GLuint readBuffer,
    GLuint writeBuffer, GLintptr readOffset, GLintptr writeOffset,
    GLsizeiptr size);
typedef int(GLAD_API_PTR *PFNGLXQUERYCHANNELDELTASSGIXPROC)(X::Display *display,
                                                            int screen,
                                                            int channel, int *x,
                                                            int *y, int *w,
                                                            int *h);
typedef int(GLAD_API_PTR *PFNGLXQUERYCHANNELRECTSGIXPROC)(X::Display *display,
                                                          int screen,
                                                          int channel, int *dx,
                                                          int *dy, int *dw,
                                                          int *dh);
typedef int(GLAD_API_PTR *PFNGLXQUERYCONTEXTPROC)(X::Display *dpy,
                                                  GLXContext ctx, int attribute,
                                                  int *value);
typedef int(GLAD_API_PTR *PFNGLXQUERYCONTEXTINFOEXTPROC)(X::Display *dpy,
                                                         GLXContext context,
                                                         int attribute,
                                                         int *value);
...
typedef const char *(GLAD_API_PTR *PFNGLXQUERYCURRENTRENDERERSTRINGMESAPROC)(
    int attribute);
typedef void(GLAD_API_PTR *PFNGLXQUERYDRAWABLEPROC)(X::Display *dpy,
                                                    GLXDrawable draw,
                                                    int attribute,
                                                    unsigned int *value);
typedef bool(GLAD_API_PTR *PFNGLXQUERYEXTENSIONPROC)(X::Display *dpy,
                                                     int *errorb, int *event);
typedef const char *(GLAD_API_PTR *PFNGLXQUERYEXTENSIONSSTRINGPROC)(
    X::Display *dpy, int screen);
typedef bool(GLAD_API_PTR *PFNGLXQUERYFRAMECOUNTNVPROC)(X::Display *dpy,
                                                        int screen,
                                                        GLuint *count);
typedef void(GLAD_API_PTR *PFNGLXQUERYGLXPBUFFERSGIXPROC)(X::Display *dpy,
                                                          GLXPbufferSGIX pbuf,
                                                          int attribute,
                                                          unsigned int *value);
typedef int(GLAD_API_PTR *PFNGLXQUERYHYPERPIPEATTRIBSGIXPROC)(
    X::Display *dpy, int timeSlice, int attrib, int size,
    void *returnAttribList);
typedef int(GLAD_API_PTR *PFNGLXQUERYHYPERPIPEBESTATTRIBSGIXPROC)(
    X::Display *dpy, int timeSlice, int attrib, int size, void *attribList,
    void *returnAttribList);
typedef GLXHyperpipeConfigSGIX *(
    GLAD_API_PTR *PFNGLXQUERYHYPERPIPECONFIGSGIXPROC)(X::Display *dpy, int hpId,
                                                      int *npipes);
typedef GLXHyperpipeNetworkSGIX *(
    GLAD_API_PTR *PFNGLXQUERYHYPERPIPENETWORKSGIXPROC)(X::Display *dpy,
                                                       int *npipes);
typedef bool(GLAD_API_PTR *PFNGLXQUERYMAXSWAPBARRIERSSGIXPROC)(X::Display *dpy,
                                                               int screen,
                                                               int *max);
typedef bool(GLAD_API_PTR *PFNGLXQUERYMAXSWAPGROUPSNVPROC)(X::Display *dpy,
                                                           int screen,
                                                           GLuint *maxGroups,
                                                           GLuint *maxBarriers);
typedef bool(GLAD_API_PTR *PFNGLXQUERYRENDERERINTEGERMESAPROC)(
    X::Display *dpy, int screen, int renderer, int attribute,
    unsigned int *value);
typedef const char *(GLAD_API_PTR *PFNGLXQUERYRENDERERSTRINGMESAPROC)(
    X::Display *dpy, int screen, int renderer, int attribute);
typedef const char *(GLAD_API_PTR *PFNGLXQUERYSERVERSTRINGPROC)(X::Display *dpy,
                                                                int screen,
                                                                int name);
typedef bool(GLAD_API_PTR *PFNGLXQUERYSWAPGROUPNVPROC)(X::Display *dpy,
                                                       GLXDrawable drawable,
                                                       GLuint *group,
                                                       GLuint *barrier);
typedef bool(GLAD_API_PTR *PFNGLXQUERYVERSIONPROC)(X::Display *dpy, int *maj,
                                                   int *min);
typedef int(GLAD_API_PTR *PFNGLXQUERYVIDEOCAPTUREDEVICENVPROC)(
    X::Display *dpy, GLXVideoCaptureDeviceNV device, int attribute, int *value);
typedef bool(GLAD_API_PTR *PFNGLXRELEASEBUFFERSMESAPROC)(X::Display *dpy,
                                                         GLXDrawable drawable);
typedef void(GLAD_API_PTR *PFNGLXRELEASETEXIMAGEEXTPROC)(X::Display *dpy,
                                                         GLXDrawable drawable,
                                                         int buffer);
...
typedef int(GLAD_API_PTR *PFNGLXRELEASEVIDEODEVICENVPROC)(
    X::Display *dpy, int screen, GLXVideoDeviceNV VideoDevice);
typedef int(GLAD_API_PTR *PFNGLXRELEASEVIDEOIMAGENVPROC)(X::Display *dpy,
                                                         GLXPbuffer pbuf);
typedef bool(GLAD_API_PTR *PFNGLXRESETFRAMECOUNTNVPROC)(X::Display *dpy,
                                                        int screen);
typedef void(GLAD_API_PTR *PFNGLXSELECTEVENTPROC)(X::Display *dpy,
                                                  GLXDrawable draw,
                                                  unsigned long event_mask);
typedef void(GLAD_API_PTR *PFNGLXSELECTEVENTSGIXPROC)(X::Display *dpy,
                                                      GLXDrawable drawable,
                                                      unsigned long mask);
typedef int(GLAD_API_PTR *PFNGLXSENDPBUFFERTOVIDEONVPROC)(
    X::Display *dpy, GLXPbuffer pbuf, int iBufferType,
    unsigned long *pulCounterPbuffer, GLboolean bBlock);
typedef GLboolean(GLAD_API_PTR *PFNGLXSET3DFXMODEMESAPROC)(GLint mode);
typedef void(GLAD_API_PTR *PFNGLXSWAPBUFFERSPROC)(X::Display *dpy,
                                                  GLXDrawable drawable);
typedef int64_t(GLAD_API_PTR *PFNGLXSWAPBUFFERSMSCOMLPROC)(X::Display *dpy,
                                                           GLXDrawable drawable,
                                                           int64_t target_msc,
                                                           int64_t divisor,
                                                           int64_t remainder);
typedef void(GLAD_API_PTR *PFNGLXSWAPINTERVALEXTPROC)(X::Display *dpy,
                                                      GLXDrawable drawable,
                                                      int interval);
...
typedef void(GLAD_API_PTR *PFNGLXUSEXFONTPROC)(X::Font font, int first,
                                               int count, int list);
typedef bool(GLAD_API_PTR *PFNGLXWAITFORMSCOMLPROC)(
    X::Display *dpy, GLXDrawable drawable, int64_t target_msc, int64_t divisor,
    int64_t remainder, int64_t *ust, int64_t *msc, int64_t *sbc);
typedef bool(GLAD_API_PTR *PFNGLXWAITFORSBCOMLPROC)(X::Display *dpy,
                                                    GLXDrawable drawable,
                                                    int64_t target_sbc,
...
#define glXBindChannelToWindowSGIX glad_glXBindChannelToindowSGIX
...
#define glXCreateX ::Window glad_glXCreateX::Window
...
GLAD_API_CALL int gladLoadGLXUserPtr(X::Display *display, int screen,
                                     GLADuserptrloadfunc load, void *userptr);
GLAD_API_CALL int gladLoadGLX(X::Display *display, int screen,
                              GLADloadfunc load);

#ifdef GLAD_GLX

GLAD_API_CALL int gladLoaderLoadGLX(X::Display *display, int screen);
