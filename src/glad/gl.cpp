...
static void glad_gl_load_GL_ARB_imaging(GLADuserptrloadfunc load,
  ...
  glad_glBlendEquation =
      (PFNGLBLENDEQUATIONPROC)load(userptr, "glBlendEquation");
  glad_glColorSubTable =
      (PFNGLCOLORSUBTABLEPROC)load(userptr, "glColorSubTable");
  ...
  glad_glConvolutionParameterfv = (PFNGLCONVOLUTIONPARAMETERFVPROC)load(
      userptr, "glConvolutionParameterfv");
  ...
  glad_glConvolutionParameteriv = (PFNGLCONVOLUTIONPARAMETERIVPROC)load(
      userptr, "glConvolutionParameteriv");
  glad_glCopyColorSubTable =
      (PFNGLCOPYCOLORSUBTABLEPROC)load(userptr, "glCopyColorSubTable");
  glad_glCopyColorTable =
      (PFNGLCOPYCOLORTABLEPROC)load(userptr, "glCopyColorTable");
  glad_glCopyConvolutionFilter1D = (PFNGLCOPYCONVOLUTIONFILTER1DPROC)load(
      userptr, "glCopyConvolutionFilter1D");
  glad_glCopyConvolutionFilter2D = (PFNGLCOPYCONVOLUTIONFILTER2DPROC)load(
      userptr, "glCopyConvolutionFilter2D");
  glad_glGetColorTable =
      (PFNGLGETCOLORTABLEPROC)load(userptr, "glGetColorTable");
  glad_glGetColorTableParameterfv = (PFNGLGETCOLORTABLEPARAMETERFVPROC)load(
      userptr, "glGetColorTableParameterfv");
  glad_glGetColorTableParameteriv = (PFNGLGETCOLORTABLEPARAMETERIVPROC)load(
      userptr, "glGetColorTableParameteriv");
  glad_glGetConvolutionFilter =
      (PFNGLGETCONVOLUTIONFILTERPROC)load(userptr, "glGetConvolutionFilter");
  glad_glGetConvolutionParameterfv = (PFNGLGETCONVOLUTIONPARAMETERFVPROC)load(
      userptr, "glGetConvolutionParameterfv");
  glad_glGetConvolutionParameteriv = (PFNGLGETCONVOLUTIONPARAMETERIVPROC)load(
      userptr, "glGetConvolutionParameteriv");
  ...
  glad_glGetSeparableFilter =
      (PFNGLGETSEPARABLEFILTERPROC)load(userptr, "glGetSeparableFilter");
  ...
  glad_glResetHistogram =
      (PFNGLRESETHISTOGRAMPROC)load(userptr, "glResetHistogram");
  glad_glResetMinmax = (PFNGLRESETMINMAXPROC)load(userptr, "glResetMinmax");
  glad_glSeparableFilter2D =
      (PFNGLSEPARABLEFILTER2DPROC)load(userptr, "glSeparableFilter2D");
}
...
static void glad_gl_load_GL_NV_path_rendering(GLADuserptrloadfunc load,
  ...
  glad_glGetPathTexGenfvNV =
      (PFNGLGETPATHTEXGENFVNVPROC)load(userptr, "glGetPathTexGenfvNV");
  glad_glGetPathTexGenivNV =
      (PFNGLGETPATHTEXGENIVNVPROC)load(userptr, "glGetPathTexGenivNV");
  ...
  glad_glPathColorGenNV =
      (PFNGLPATHCOLORGENNVPROC)load(userptr, "glPathColorGenNV");
...
static void glad_gl_resolve_aliases(void) {
  ...
  if (glad_glBlendEquationSeparatei == NULL &&
    ...
    glad_glBlendEquationSeparatei =
        (PFNGLBLENDEQUATIONSEPARATEIPROC)glad_glBlendEquationSeparateIndexedAMD;
  if (glad_glBlendEquationSeparatei == NULL &&
  ...
  if (glad_glClientActiveTexture == NULL &&
      glad_glClientActiveTextureARB != NULL)
    glad_glClientActiveTexture =
        (PFNGLCLIENTACTIVETEXTUREPROC)glad_glClientActiveTextureARB;
  if (glad_glClientActiveTextureARB == NULL &&
      glad_glClientActiveTexture != NULL)
    glad_glClientActiveTextureARB =
        (PFNGLCLIENTACTIVETEXTUREARBPROC)glad_glClientActiveTexture;
  ...
  if (glad_glColorSubTable == NULL && glad_glColorSubTableEXT != NULL)
    glad_glColorSubTable = (PFNGLCOLORSUBTABLEPROC)glad_glColorSubTableEXT;
  if (glad_glColorSubTableEXT == NULL && glad_glColorSubTable != NULL)
    glad_glColorSubTableEXT = (PFNGLCOLORSUBTABLEEXTPROC)glad_glColorSubTable;
  if (glad_glColorTable == NULL && glad_glColorTableEXT != NULL)
    glad_glColorTable = (PFNGLCOLORTABLEPROC)glad_glColorTableEXT;
  if (glad_glColorTable == NULL && glad_glColorTableSGI != NULL)
    glad_glColorTable = (PFNGLCOLORTABLEPROC)glad_glColorTableSGI;
  if (glad_glColorTableEXT == NULL && glad_glColorTable != NULL)
    glad_glColorTableEXT = (PFNGLCOLORTABLEEXTPROC)glad_glColorTable;
  if (glad_glColorTableEXT == NULL && glad_glColorTableSGI != NULL)
    glad_glColorTableEXT = (PFNGLCOLORTABLEEXTPROC)glad_glColorTableSGI;
  if (glad_glColorTableParameterfv == NULL &&
      glad_glColorTableParameterfvSGI != NULL)
    glad_glColorTableParameterfv =
        (PFNGLCOLORTABLEPARAMETERFVPROC)glad_glColorTableParameterfvSGI;
  if (glad_glColorTableParameterfvSGI == NULL &&
      glad_glColorTableParameterfv != NULL)
    glad_glColorTableParameterfvSGI =
        (PFNGLCOLORTABLEPARAMETERFVSGIPROC)glad_glColorTableParameterfv;
  if (glad_glColorTableParameteriv == NULL &&
      glad_glColorTableParameterivSGI != NULL)
    glad_glColorTableParameteriv =
        (PFNGLCOLORTABLEPARAMETERIVPROC)glad_glColorTableParameterivSGI;
  if (glad_glColorTableParameterivSGI == NULL &&
      glad_glColorTableParameteriv != NULL)
    glad_glColorTableParameterivSGI =
        (PFNGLCOLORTABLEPARAMETERIVSGIPROC)glad_glColorTableParameteriv;
  if (glad_glColorTableSGI == NULL && glad_glColorTable != NULL)
    glad_glColorTableSGI = (PFNGLCOLORTABLESGIPROC)glad_glColorTable;
  if (glad_glColorTableSGI == NULL && glad_glColorTableEXT != NULL)
    glad_glColorTableSGI = (PFNGLCOLORTABLESGIPROC)glad_glColorTableEXT;
  ...
  if (glad_glConvolutionFilter1D == NULL &&
      glad_glConvolutionFilter1DEXT != NULL)
    glad_glConvolutionFilter1D =
        (PFNGLCONVOLUTIONFILTER1DPROC)glad_glConvolutionFilter1DEXT;
  if (glad_glConvolutionFilter1DEXT == NULL &&
      glad_glConvolutionFilter1D != NULL)
    glad_glConvolutionFilter1DEXT =
        (PFNGLCONVOLUTIONFILTER1DEXTPROC)glad_glConvolutionFilter1D;
  if (glad_glConvolutionFilter2D == NULL &&
      glad_glConvolutionFilter2DEXT != NULL)
    glad_glConvolutionFilter2D =
        (PFNGLCONVOLUTIONFILTER2DPROC)glad_glConvolutionFilter2DEXT;
  if (glad_glConvolutionFilter2DEXT == NULL &&
      glad_glConvolutionFilter2D != NULL)
    glad_glConvolutionFilter2DEXT =
        (PFNGLCONVOLUTIONFILTER2DEXTPROC)glad_glConvolutionFilter2D;
  if (glad_glConvolutionParameterf == NULL &&
      glad_glConvolutionParameterfEXT != NULL)
    glad_glConvolutionParameterf =
        (PFNGLCONVOLUTIONPARAMETERFPROC)glad_glConvolutionParameterfEXT;
  if (glad_glConvolutionParameterfEXT == NULL &&
      glad_glConvolutionParameterf != NULL)
    glad_glConvolutionParameterfEXT =
        (PFNGLCONVOLUTIONPARAMETERFEXTPROC)glad_glConvolutionParameterf;
  if (glad_glConvolutionParameterfv == NULL &&
      glad_glConvolutionParameterfvEXT != NULL)
    glad_glConvolutionParameterfv =
        (PFNGLCONVOLUTIONPARAMETERFVPROC)glad_glConvolutionParameterfvEXT;
  if (glad_glConvolutionParameterfvEXT == NULL &&
      glad_glConvolutionParameterfv != NULL)
    glad_glConvolutionParameterfvEXT =
        (PFNGLCONVOLUTIONPARAMETERFVEXTPROC)glad_glConvolutionParameterfv;
  if (glad_glConvolutionParameteri == NULL &&
      glad_glConvolutionParameteriEXT != NULL)
    glad_glConvolutionParameteri =
        (PFNGLCONVOLUTIONPARAMETERIPROC)glad_glConvolutionParameteriEXT;
  if (glad_glConvolutionParameteriEXT == NULL &&
      glad_glConvolutionParameteri != NULL)
    glad_glConvolutionParameteriEXT =
        (PFNGLCONVOLUTIONPARAMETERIEXTPROC)glad_glConvolutionParameteri;
  if (glad_glConvolutionParameteriv == NULL &&
      glad_glConvolutionParameterivEXT != NULL)
    glad_glConvolutionParameteriv =
        (PFNGLCONVOLUTIONPARAMETERIVPROC)glad_glConvolutionParameterivEXT;
  if (glad_glConvolutionParameterivEXT == NULL &&
      glad_glConvolutionParameteriv != NULL)
    glad_glConvolutionParameterivEXT =
        (PFNGLCONVOLUTIONPARAMETERIVEXTPROC)glad_glConvolutionParameteriv;
  if (glad_glCopyColorSubTable == NULL && glad_glCopyColorSubTableEXT != NULL)
    glad_glCopyColorSubTable =
        (PFNGLCOPYCOLORSUBTABLEPROC)glad_glCopyColorSubTableEXT;
  if (glad_glCopyColorSubTableEXT == NULL && glad_glCopyColorSubTable != NULL)
    glad_glCopyColorSubTableEXT =
        (PFNGLCOPYCOLORSUBTABLEEXTPROC)glad_glCopyColorSubTable;
  if (glad_glCopyColorTable == NULL && glad_glCopyColorTableSGI != NULL)
    glad_glCopyColorTable = (PFNGLCOPYCOLORTABLEPROC)glad_glCopyColorTableSGI;
  if (glad_glCopyColorTableSGI == NULL && glad_glCopyColorTable != NULL)
    glad_glCopyColorTableSGI =
        (PFNGLCOPYCOLORTABLESGIPROC)glad_glCopyColorTable;
  if (glad_glCopyConvolutionFilter1D == NULL &&
      glad_glCopyConvolutionFilter1DEXT != NULL)
    glad_glCopyConvolutionFilter1D =
        (PFNGLCOPYCONVOLUTIONFILTER1DPROC)glad_glCopyConvolutionFilter1DEXT;
  if (glad_glCopyConvolutionFilter1DEXT == NULL &&
      glad_glCopyConvolutionFilter1D != NULL)
    glad_glCopyConvolutionFilter1DEXT =
        (PFNGLCOPYCONVOLUTIONFILTER1DEXTPROC)glad_glCopyConvolutionFilter1D;
  if (glad_glCopyConvolutionFilter2D == NULL &&
      glad_glCopyConvolutionFilter2DEXT != NULL)
    glad_glCopyConvolutionFilter2D =
        (PFNGLCOPYCONVOLUTIONFILTER2DPROC)glad_glCopyConvolutionFilter2DEXT;
  if (glad_glCopyConvolutionFilter2DEXT == NULL &&
      glad_glCopyConvolutionFilter2D != NULL)
    glad_glCopyConvolutionFilter2DEXT =
        (PFNGLCOPYCONVOLUTIONFILTER2DEXTPROC)glad_glCopyConvolutionFilter2D;
  ...
  if (glad_glDeleteTransformFeedbacks == NULL &&
    ...
    glad_glDeleteTransformFeedbacks =
        (PFNGLDELETETRANSFORMFEEDBACKSPROC)glad_glDeleteTransformFeedbacksNV;
  if (glad_glDeleteTransformFeedbacksNV == NULL &&
      glad_glDeleteTransformFeedbacks != NULL)
    glad_glDeleteTransformFeedbacksNV =
        (PFNGLDELETETRANSFORMFEEDBACKSNVPROC)glad_glDeleteTransformFeedbacks;
  ...
  if (glad_glDisableVertexAttribArray == NULL &&
    ...
    glad_glDisableVertexAttribArray =
        (PFNGLDISABLEVERTEXATTRIBARRAYPROC)glad_glDisableVertexAttribArrayARB;
  ...
  if (glad_glFogCoordd == NULL && glad_glFogCoorddEXT != NULL)
    glad_glFogCoordd = (PFNGLFOGCOORDDPROC)glad_glFogCoorddEXT;
  if (glad_glFogCoorddEXT == NULL && glad_glFogCoordd != NULL)
    glad_glFogCoorddEXT = (PFNGLFOGCOORDDEXTPROC)glad_glFogCoordd;
  if (glad_glFogCoorddv == NULL && glad_glFogCoorddvEXT != NULL)
    glad_glFogCoorddv = (PFNGLFOGCOORDDVPROC)glad_glFogCoorddvEXT;
  if (glad_glFogCoorddvEXT == NULL && glad_glFogCoorddv != NULL)
    glad_glFogCoorddvEXT = (PFNGLFOGCOORDDVEXTPROC)glad_glFogCoorddv;
  if (glad_glFogCoordf == NULL && glad_glFogCoordfEXT != NULL)
    glad_glFogCoordf = (PFNGLFOGCOORDFPROC)glad_glFogCoordfEXT;
  if (glad_glFogCoordfEXT == NULL && glad_glFogCoordf != NULL)
    glad_glFogCoordfEXT = (PFNGLFOGCOORDFEXTPROC)glad_glFogCoordf;
  if (glad_glFogCoordfv == NULL && glad_glFogCoordfvEXT != NULL)
    glad_glFogCoordfv = (PFNGLFOGCOORDFVPROC)glad_glFogCoordfvEXT;
  if (glad_glFogCoordfvEXT == NULL && glad_glFogCoordfv != NULL)
    glad_glFogCoordfvEXT = (PFNGLFOGCOORDFVEXTPROC)glad_glFogCoordfv;
  if (glad_glFogCoordPointer == NULL && glad_glFogCoordPointerEXT != NULL)
    glad_glFogCoordPointer =
        (PFNGLFOGCOORDPOINTERPROC)glad_glFogCoordPointerEXT;
  if (glad_glFogCoordPointerEXT == NULL && glad_glFogCoordPointer != NULL)
    glad_glFogCoordPointerEXT =
        (PFNGLFOGCOORDPOINTEREXTPROC)glad_glFogCoordPointer;
  ...
  if (glad_glFramebufferTextureFaceARB == NULL &&
    ...
    glad_glFramebufferTextureFaceARB =
        (PFNGLFRAMEBUFFERTEXTUREFACEARBPROC)glad_glFramebufferTextureFaceEXT;
  if (glad_glFramebufferTextureFaceEXT == NULL &&
      glad_glFramebufferTextureFaceARB != NULL)
    glad_glFramebufferTextureFaceEXT =
        (PFNGLFRAMEBUFFERTEXTUREFACEEXTPROC)glad_glFramebufferTextureFaceARB;
  ...
  if (glad_glGetColorTable == NULL && glad_glGetColorTableEXT != NULL)
    glad_glGetColorTable = (PFNGLGETCOLORTABLEPROC)glad_glGetColorTableEXT;
  if (glad_glGetColorTableEXT == NULL && glad_glGetColorTable != NULL)
    glad_glGetColorTableEXT = (PFNGLGETCOLORTABLEEXTPROC)glad_glGetColorTable;
  if (glad_glGetColorTableParameterfv == NULL &&
      glad_glGetColorTableParameterfvEXT != NULL)
    glad_glGetColorTableParameterfv =
        (PFNGLGETCOLORTABLEPARAMETERFVPROC)glad_glGetColorTableParameterfvEXT;
  if (glad_glGetColorTableParameterfvEXT == NULL &&
      glad_glGetColorTableParameterfv != NULL)
    glad_glGetColorTableParameterfvEXT =
        (PFNGLGETCOLORTABLEPARAMETERFVEXTPROC)glad_glGetColorTableParameterfv;
  if (glad_glGetColorTableParameteriv == NULL &&
      glad_glGetColorTableParameterivEXT != NULL)
    glad_glGetColorTableParameteriv =
        (PFNGLGETCOLORTABLEPARAMETERIVPROC)glad_glGetColorTableParameterivEXT;
  if (glad_glGetColorTableParameterivEXT == NULL &&
      glad_glGetColorTableParameteriv != NULL)
    glad_glGetColorTableParameterivEXT =
        (PFNGLGETCOLORTABLEPARAMETERIVEXTPROC)glad_glGetColorTableParameteriv;
  ...
  if (glad_glHistogram == NULL && glad_glHistogramEXT != NULL)
    glad_glHistogram = (PFNGLHISTOGRAMPROC)glad_glHistogramEXT;
  if (glad_glHistogramEXT == NULL && glad_glHistogram != NULL)
    glad_glHistogramEXT = (PFNGLHISTOGRAMEXTPROC)glad_glHistogram;
  ...
  if (glad_glLoadTransposeMatrixd == NULL &&
      glad_glLoadTransposeMatrixdARB != NULL)
    glad_glLoadTransposeMatrixd =
        (PFNGLLOADTRANSPOSEMATRIXDPROC)glad_glLoadTransposeMatrixdARB;
  if (glad_glLoadTransposeMatrixdARB == NULL &&
      glad_glLoadTransposeMatrixd != NULL)
    glad_glLoadTransposeMatrixdARB =
        (PFNGLLOADTRANSPOSEMATRIXDARBPROC)glad_glLoadTransposeMatrixd;
  if (glad_glLoadTransposeMatrixf == NULL &&
      glad_glLoadTransposeMatrixfARB != NULL)
    glad_glLoadTransposeMatrixf =
        (PFNGLLOADTRANSPOSEMATRIXFPROC)glad_glLoadTransposeMatrixfARB;
  if (glad_glLoadTransposeMatrixfARB == NULL &&
      glad_glLoadTransposeMatrixf != NULL)
    glad_glLoadTransposeMatrixfARB =
        (PFNGLLOADTRANSPOSEMATRIXFARBPROC)glad_glLoadTransposeMatrixf;
  ...
  if (glad_glMinmax == NULL && glad_glMinmaxEXT != NULL)
    glad_glMinmax = (PFNGLMINMAXPROC)glad_glMinmaxEXT;
  if (glad_glMinmaxEXT == NULL && glad_glMinmax != NULL)
    glad_glMinmaxEXT = (PFNGLMINMAXEXTPROC)glad_glMinmax;
  ...
  if (glad_glMultiDrawElementsIndirectAMD == NULL &&
    ...
    glad_glMultiDrawElementsIndirectAMD =
        (PFNGLMULTIDRAWELEMENTSINDIRECTAMDPROC)glad_glMultiDrawElementsIndirect;
  ...
  if (glad_glMultiTexCoord4dvARB == NULL && glad_glMultiTexCoord4dv != NULL)
    glad_glMultiTexCoord4dvARB =
        (PFNGLMULTITEXCOORD4DVARBPROC)glad_glMultiTexCoord4dv;
  if (glad_glMultiTexCoord4f == NULL && glad_glMultiTexCoord4fARB != NULL)
    glad_glMultiTexCoord4f =
        (PFNGLMULTITEXCOORD4FPROC)glad_glMultiTexCoord4fARB;
  if (glad_glMultiTexCoord4fARB == NULL && glad_glMultiTexCoord4f != NULL)
    glad_glMultiTexCoord4fARB =
        (PFNGLMULTITEXCOORD4FARBPROC)glad_glMultiTexCoord4f;
  if (glad_glMultiTexCoord4fv == NULL && glad_glMultiTexCoord4fvARB != NULL)
    glad_glMultiTexCoord4fv =
        (PFNGLMULTITEXCOORD4FVPROC)glad_glMultiTexCoord4fvARB;
  if (glad_glMultiTexCoord4fvARB == NULL && glad_glMultiTexCoord4fv != NULL)
    glad_glMultiTexCoord4fvARB =
        (PFNGLMULTITEXCOORD4FVARBPROC)glad_glMultiTexCoord4fv;
  if (glad_glMultiTexCoord4i == NULL && glad_glMultiTexCoord4iARB != NULL)
    glad_glMultiTexCoord4i =
        (PFNGLMULTITEXCOORD4IPROC)glad_glMultiTexCoord4iARB;
  if (glad_glMultiTexCoord4iARB == NULL && glad_glMultiTexCoord4i != NULL)
    glad_glMultiTexCoord4iARB =
        (PFNGLMULTITEXCOORD4IARBPROC)glad_glMultiTexCoord4i;
  if (glad_glMultiTexCoord4iv == NULL && glad_glMultiTexCoord4ivARB != NULL)
    glad_glMultiTexCoord4iv =
        (PFNGLMULTITEXCOORD4IVPROC)glad_glMultiTexCoord4ivARB;
  if (glad_glMultiTexCoord4ivARB == NULL && glad_glMultiTexCoord4iv != NULL)
    glad_glMultiTexCoord4ivARB =
        (PFNGLMULTITEXCOORD4IVARBPROC)glad_glMultiTexCoord4iv;
  if (glad_glMultiTexCoord4s == NULL && glad_glMultiTexCoord4sARB != NULL)
    glad_glMultiTexCoord4s =
        (PFNGLMULTITEXCOORD4SPROC)glad_glMultiTexCoord4sARB;
  if (glad_glMultiTexCoord4sARB == NULL && glad_glMultiTexCoord4s != NULL)
    glad_glMultiTexCoord4sARB =
        (PFNGLMULTITEXCOORD4SARBPROC)glad_glMultiTexCoord4s;
  if (glad_glMultiTexCoord4sv == NULL && glad_glMultiTexCoord4svARB != NULL)
    glad_glMultiTexCoord4sv =
        (PFNGLMULTITEXCOORD4SVPROC)glad_glMultiTexCoord4svARB;
  if (glad_glMultiTexCoord4svARB == NULL && glad_glMultiTexCoord4sv != NULL)
    glad_glMultiTexCoord4svARB =
        (PFNGLMULTITEXCOORD4SVARBPROC)glad_glMultiTexCoord4sv;
  if (glad_glMultTransposeMatrixd == NULL &&
      glad_glMultTransposeMatrixdARB != NULL)
    glad_glMultTransposeMatrixd =
        (PFNGLMULTTRANSPOSEMATRIXDPROC)glad_glMultTransposeMatrixdARB;
  if (glad_glMultTransposeMatrixdARB == NULL &&
      glad_glMultTransposeMatrixd != NULL)
    glad_glMultTransposeMatrixdARB =
        (PFNGLMULTTRANSPOSEMATRIXDARBPROC)glad_glMultTransposeMatrixd;
  if (glad_glMultTransposeMatrixf == NULL &&
      glad_glMultTransposeMatrixfARB != NULL)
    glad_glMultTransposeMatrixf =
        (PFNGLMULTTRANSPOSEMATRIXFPROC)glad_glMultTransposeMatrixfARB;
  if (glad_glMultTransposeMatrixfARB == NULL &&
      glad_glMultTransposeMatrixf != NULL)
    glad_glMultTransposeMatrixfARB =
        (PFNGLMULTTRANSPOSEMATRIXFARBPROC)glad_glMultTransposeMatrixf;
  ...
  if (glad_glPrioritizeTextures == NULL && glad_glPrioritizeTexturesEXT != NULL)
    glad_glPrioritizeTextures =
        (PFNGLPRIORITIZETEXTURESPROC)glad_glPrioritizeTexturesEXT;
  if (glad_glPrioritizeTexturesEXT == NULL && glad_glPrioritizeTextures != NULL)
    glad_glPrioritizeTexturesEXT =
        (PFNGLPRIORITIZETEXTURESEXTPROC)glad_glPrioritizeTextures;
  ...
  if (glad_glProgramUniformMatrix2x3fv == NULL &&
    ...
    glad_glProgramUniformMatrix2x3fv =
        (PFNGLPROGRAMUNIFORMMATRIX2X3FVPROC)glad_glProgramUniformMatrix2x3fvEXT;
  if (glad_glProgramUniformMatrix2x3fvEXT == NULL &&
      glad_glProgramUniformMatrix2x3fv != NULL)
    glad_glProgramUniformMatrix2x3fvEXT =
        (PFNGLPROGRAMUNIFORMMATRIX2X3FVEXTPROC)glad_glProgramUniformMatrix2x3fv;
  if (glad_glProgramUniformMatrix2x4fv == NULL &&
      glad_glProgramUniformMatrix2x4fvEXT != NULL)
    glad_glProgramUniformMatrix2x4fv =
        (PFNGLPROGRAMUNIFORMMATRIX2X4FVPROC)glad_glProgramUniformMatrix2x4fvEXT;
  if (glad_glProgramUniformMatrix2x4fvEXT == NULL &&
      glad_glProgramUniformMatrix2x4fv != NULL)
    glad_glProgramUniformMatrix2x4fvEXT =
        (PFNGLPROGRAMUNIFORMMATRIX2X4FVEXTPROC)glad_glProgramUniformMatrix2x4fv;
  ...
  if (glad_glProgramUniformMatrix3x2fvEXT == NULL &&
    ...
    glad_glProgramUniformMatrix3x2fvEXT =
        (PFNGLPROGRAMUNIFORMMATRIX3X2FVEXTPROC)glad_glProgramUniformMatrix3x2fv;
  if (glad_glProgramUniformMatrix3x4fv == NULL &&
      glad_glProgramUniformMatrix3x4fvEXT != NULL)
    glad_glProgramUniformMatrix3x4fv =
        (PFNGLPROGRAMUNIFORMMATRIX3X4FVPROC)glad_glProgramUniformMatrix3x4fvEXT;
  if (glad_glProgramUniformMatrix3x4fvEXT == NULL &&
      glad_glProgramUniformMatrix3x4fv != NULL)
    glad_glProgramUniformMatrix3x4fvEXT =
        (PFNGLPROGRAMUNIFORMMATRIX3X4FVEXTPROC)glad_glProgramUniformMatrix3x4fv;
  ...
  if (glad_glProgramUniformMatrix4x2fv == NULL &&
    ...
    glad_glProgramUniformMatrix4x2fv =
        (PFNGLPROGRAMUNIFORMMATRIX4X2FVPROC)glad_glProgramUniformMatrix4x2fvEXT;
  if (glad_glProgramUniformMatrix4x2fvEXT == NULL &&
      glad_glProgramUniformMatrix4x2fv != NULL)
    glad_glProgramUniformMatrix4x2fvEXT =
        (PFNGLPROGRAMUNIFORMMATRIX4X2FVEXTPROC)glad_glProgramUniformMatrix4x2fv;
  if (glad_glProgramUniformMatrix4x3fv == NULL &&
      glad_glProgramUniformMatrix4x3fvEXT != NULL)
    glad_glProgramUniformMatrix4x3fv =
        (PFNGLPROGRAMUNIFORMMATRIX4X3FVPROC)glad_glProgramUniformMatrix4x3fvEXT;
  if (glad_glProgramUniformMatrix4x3fvEXT == NULL &&
      glad_glProgramUniformMatrix4x3fv != NULL)
    glad_glProgramUniformMatrix4x3fvEXT =
        (PFNGLPROGRAMUNIFORMMATRIX4X3FVEXTPROC)glad_glProgramUniformMatrix4x3fv;
  ...
  if (glad_glRenderbufferStorageMultisampleEXT == NULL &&
    ...
    glad_glRenderbufferStorageMultisampleEXT =
        (PFNGLRENDERBUFFERSTORAGEMULTISAMPLEEXTPROC)
            glad_glRenderbufferStorageMultisample;
  if (glad_glResetHistogram == NULL && glad_glResetHistogramEXT != NULL)
    glad_glResetHistogram = (PFNGLRESETHISTOGRAMPROC)glad_glResetHistogramEXT;
  if (glad_glResetHistogramEXT == NULL && glad_glResetHistogram != NULL)
    glad_glResetHistogramEXT =
        (PFNGLRESETHISTOGRAMEXTPROC)glad_glResetHistogram;
  if (glad_glResetMinmax == NULL && glad_glResetMinmaxEXT != NULL)
    glad_glResetMinmax = (PFNGLRESETMINMAXPROC)glad_glResetMinmaxEXT;
  if (glad_glResetMinmaxEXT == NULL && glad_glResetMinmax != NULL)
    glad_glResetMinmaxEXT = (PFNGLRESETMINMAXEXTPROC)glad_glResetMinmax;
  ...
  if (glad_glSecondaryColor3b == NULL && glad_glSecondaryColor3bEXT != NULL)
    glad_glSecondaryColor3b =
        (PFNGLSECONDARYCOLOR3BPROC)glad_glSecondaryColor3bEXT;
  if (glad_glSecondaryColor3bEXT == NULL && glad_glSecondaryColor3b != NULL)
    glad_glSecondaryColor3bEXT =
        (PFNGLSECONDARYCOLOR3BEXTPROC)glad_glSecondaryColor3b;
  if (glad_glSecondaryColor3bv == NULL && glad_glSecondaryColor3bvEXT != NULL)
    glad_glSecondaryColor3bv =
        (PFNGLSECONDARYCOLOR3BVPROC)glad_glSecondaryColor3bvEXT;
  if (glad_glSecondaryColor3bvEXT == NULL && glad_glSecondaryColor3bv != NULL)
    glad_glSecondaryColor3bvEXT =
        (PFNGLSECONDARYCOLOR3BVEXTPROC)glad_glSecondaryColor3bv;
  if (glad_glSecondaryColor3d == NULL && glad_glSecondaryColor3dEXT != NULL)
    glad_glSecondaryColor3d =
        (PFNGLSECONDARYCOLOR3DPROC)glad_glSecondaryColor3dEXT;
  if (glad_glSecondaryColor3dEXT == NULL && glad_glSecondaryColor3d != NULL)
    glad_glSecondaryColor3dEXT =
        (PFNGLSECONDARYCOLOR3DEXTPROC)glad_glSecondaryColor3d;
  if (glad_glSecondaryColor3dv == NULL && glad_glSecondaryColor3dvEXT != NULL)
    glad_glSecondaryColor3dv =
        (PFNGLSECONDARYCOLOR3DVPROC)glad_glSecondaryColor3dvEXT;
  if (glad_glSecondaryColor3dvEXT == NULL && glad_glSecondaryColor3dv != NULL)
    glad_glSecondaryColor3dvEXT =
        (PFNGLSECONDARYCOLOR3DVEXTPROC)glad_glSecondaryColor3dv;
  if (glad_glSecondaryColor3f == NULL && glad_glSecondaryColor3fEXT != NULL)
    glad_glSecondaryColor3f =
        (PFNGLSECONDARYCOLOR3FPROC)glad_glSecondaryColor3fEXT;
  if (glad_glSecondaryColor3fEXT == NULL && glad_glSecondaryColor3f != NULL)
    glad_glSecondaryColor3fEXT =
        (PFNGLSECONDARYCOLOR3FEXTPROC)glad_glSecondaryColor3f;
  if (glad_glSecondaryColor3fv == NULL && glad_glSecondaryColor3fvEXT != NULL)
    glad_glSecondaryColor3fv =
        (PFNGLSECONDARYCOLOR3FVPROC)glad_glSecondaryColor3fvEXT;
  if (glad_glSecondaryColor3fvEXT == NULL && glad_glSecondaryColor3fv != NULL)
    glad_glSecondaryColor3fvEXT =
        (PFNGLSECONDARYCOLOR3FVEXTPROC)glad_glSecondaryColor3fv;
  if (glad_glSecondaryColor3i == NULL && glad_glSecondaryColor3iEXT != NULL)
    glad_glSecondaryColor3i =
        (PFNGLSECONDARYCOLOR3IPROC)glad_glSecondaryColor3iEXT;
  if (glad_glSecondaryColor3iEXT == NULL && glad_glSecondaryColor3i != NULL)
    glad_glSecondaryColor3iEXT =
        (PFNGLSECONDARYCOLOR3IEXTPROC)glad_glSecondaryColor3i;
  if (glad_glSecondaryColor3iv == NULL && glad_glSecondaryColor3ivEXT != NULL)
    glad_glSecondaryColor3iv =
        (PFNGLSECONDARYCOLOR3IVPROC)glad_glSecondaryColor3ivEXT;
  if (glad_glSecondaryColor3ivEXT == NULL && glad_glSecondaryColor3iv != NULL)
    glad_glSecondaryColor3ivEXT =
        (PFNGLSECONDARYCOLOR3IVEXTPROC)glad_glSecondaryColor3iv;
  if (glad_glSecondaryColor3s == NULL && glad_glSecondaryColor3sEXT != NULL)
    glad_glSecondaryColor3s =
        (PFNGLSECONDARYCOLOR3SPROC)glad_glSecondaryColor3sEXT;
  if (glad_glSecondaryColor3sEXT == NULL && glad_glSecondaryColor3s != NULL)
    glad_glSecondaryColor3sEXT =
        (PFNGLSECONDARYCOLOR3SEXTPROC)glad_glSecondaryColor3s;
  if (glad_glSecondaryColor3sv == NULL && glad_glSecondaryColor3svEXT != NULL)
    glad_glSecondaryColor3sv =
        (PFNGLSECONDARYCOLOR3SVPROC)glad_glSecondaryColor3svEXT;
  if (glad_glSecondaryColor3svEXT == NULL && glad_glSecondaryColor3sv != NULL)
    glad_glSecondaryColor3svEXT =
        (PFNGLSECONDARYCOLOR3SVEXTPROC)glad_glSecondaryColor3sv;
  if (glad_glSecondaryColor3ub == NULL && glad_glSecondaryColor3ubEXT != NULL)
    glad_glSecondaryColor3ub =
        (PFNGLSECONDARYCOLOR3UBPROC)glad_glSecondaryColor3ubEXT;
  if (glad_glSecondaryColor3ubEXT == NULL && glad_glSecondaryColor3ub != NULL)
    glad_glSecondaryColor3ubEXT =
        (PFNGLSECONDARYCOLOR3UBEXTPROC)glad_glSecondaryColor3ub;
  if (glad_glSecondaryColor3ubv == NULL && glad_glSecondaryColor3ubvEXT != NULL)
    glad_glSecondaryColor3ubv =
        (PFNGLSECONDARYCOLOR3UBVPROC)glad_glSecondaryColor3ubvEXT;
  if (glad_glSecondaryColor3ubvEXT == NULL && glad_glSecondaryColor3ubv != NULL)
    glad_glSecondaryColor3ubvEXT =
        (PFNGLSECONDARYCOLOR3UBVEXTPROC)glad_glSecondaryColor3ubv;
  if (glad_glSecondaryColor3ui == NULL && glad_glSecondaryColor3uiEXT != NULL)
    glad_glSecondaryColor3ui =
        (PFNGLSECONDARYCOLOR3UIPROC)glad_glSecondaryColor3uiEXT;
  if (glad_glSecondaryColor3uiEXT == NULL && glad_glSecondaryColor3ui != NULL)
    glad_glSecondaryColor3uiEXT =
        (PFNGLSECONDARYCOLOR3UIEXTPROC)glad_glSecondaryColor3ui;
  if (glad_glSecondaryColor3uiv == NULL && glad_glSecondaryColor3uivEXT != NULL)
    glad_glSecondaryColor3uiv =
        (PFNGLSECONDARYCOLOR3UIVPROC)glad_glSecondaryColor3uivEXT;
  if (glad_glSecondaryColor3uivEXT == NULL && glad_glSecondaryColor3uiv != NULL)
    glad_glSecondaryColor3uivEXT =
        (PFNGLSECONDARYCOLOR3UIVEXTPROC)glad_glSecondaryColor3uiv;
  if (glad_glSecondaryColor3us == NULL && glad_glSecondaryColor3usEXT != NULL)
    glad_glSecondaryColor3us =
        (PFNGLSECONDARYCOLOR3USPROC)glad_glSecondaryColor3usEXT;
  if (glad_glSecondaryColor3usEXT == NULL && glad_glSecondaryColor3us != NULL)
    glad_glSecondaryColor3usEXT =
        (PFNGLSECONDARYCOLOR3USEXTPROC)glad_glSecondaryColor3us;
  if (glad_glSecondaryColor3usv == NULL && glad_glSecondaryColor3usvEXT != NULL)
    glad_glSecondaryColor3usv =
        (PFNGLSECONDARYCOLOR3USVPROC)glad_glSecondaryColor3usvEXT;
  if (glad_glSecondaryColor3usvEXT == NULL && glad_glSecondaryColor3usv != NULL)
    glad_glSecondaryColor3usvEXT =
        (PFNGLSECONDARYCOLOR3USVEXTPROC)glad_glSecondaryColor3usv;
  if (glad_glSecondaryColorPointer == NULL &&
      glad_glSecondaryColorPointerEXT != NULL)
    glad_glSecondaryColorPointer =
        (PFNGLSECONDARYCOLORPOINTERPROC)glad_glSecondaryColorPointerEXT;
  if (glad_glSecondaryColorPointerEXT == NULL &&
      glad_glSecondaryColorPointer != NULL)
    glad_glSecondaryColorPointerEXT =
        (PFNGLSECONDARYCOLORPOINTEREXTPROC)glad_glSecondaryColorPointer;
  if (glad_glSeparableFilter2D == NULL && glad_glSeparableFilter2DEXT != NULL)
    glad_glSeparableFilter2D =
        (PFNGLSEPARABLEFILTER2DPROC)glad_glSeparableFilter2DEXT;
  if (glad_glSeparableFilter2DEXT == NULL && glad_glSeparableFilter2D != NULL)
    glad_glSeparableFilter2DEXT =
        (PFNGLSEPARABLEFILTER2DEXTPROC)glad_glSeparableFilter2D;
  ...
  if (glad_glTransformFeedbackVaryings == NULL &&
    ...
    glad_glTransformFeedbackVaryings =
        (PFNGLTRANSFORMFEEDBACKVARYINGSPROC)glad_glTransformFeedbackVaryingsEXT;
  if (glad_glTransformFeedbackVaryingsEXT == NULL &&
      glad_glTransformFeedbackVaryings != NULL)
    glad_glTransformFeedbackVaryingsEXT =
        (PFNGLTRANSFORMFEEDBACKVARYINGSEXTPROC)glad_glTransformFeedbackVaryings;
  ...
  if (glad_glWindowPos2d == NULL && glad_glWindowPos2dARB != NULL)
    glad_glWindowPos2d = (PFNGLWINDOWPOS2DPROC)glad_glWindowPos2dARB;
  if (glad_glWindowPos2d == NULL && glad_glWindowPos2dMESA != NULL)
    glad_glWindowPos2d = (PFNGLWINDOWPOS2DPROC)glad_glWindowPos2dMESA;
  if (glad_glWindowPos2dARB == NULL && glad_glWindowPos2d != NULL)
    glad_glWindowPos2dARB = (PFNGLWINDOWPOS2DARBPROC)glad_glWindowPos2d;
  if (glad_glWindowPos2dARB == NULL && glad_glWindowPos2dMESA != NULL)
    glad_glWindowPos2dARB = (PFNGLWINDOWPOS2DARBPROC)glad_glWindowPos2dMESA;
  if (glad_glWindowPos2dMESA == NULL && glad_glWindowPos2d != NULL)
    glad_glWindowPos2dMESA = (PFNGLWINDOWPOS2DMESAPROC)glad_glWindowPos2d;
  if (glad_glWindowPos2dMESA == NULL && glad_glWindowPos2dARB != NULL)
    glad_glWindowPos2dMESA = (PFNGLWINDOWPOS2DMESAPROC)glad_glWindowPos2dARB;
  if (glad_glWindowPos2dv == NULL && glad_glWindowPos2dvARB != NULL)
    glad_glWindowPos2dv = (PFNGLWINDOWPOS2DVPROC)glad_glWindowPos2dvARB;
  if (glad_glWindowPos2dv == NULL && glad_glWindowPos2dvMESA != NULL)
    glad_glWindowPos2dv = (PFNGLWINDOWPOS2DVPROC)glad_glWindowPos2dvMESA;
  if (glad_glWindowPos2dvARB == NULL && glad_glWindowPos2dv != NULL)
    glad_glWindowPos2dvARB = (PFNGLWINDOWPOS2DVARBPROC)glad_glWindowPos2dv;
  if (glad_glWindowPos2dvARB == NULL && glad_glWindowPos2dvMESA != NULL)
    glad_glWindowPos2dvARB = (PFNGLWINDOWPOS2DVARBPROC)glad_glWindowPos2dvMESA;
  if (glad_glWindowPos2dvMESA == NULL && glad_glWindowPos2dv != NULL)
    glad_glWindowPos2dvMESA = (PFNGLWINDOWPOS2DVMESAPROC)glad_glWindowPos2dv;
  if (glad_glWindowPos2dvMESA == NULL && glad_glWindowPos2dvARB != NULL)
    glad_glWindowPos2dvMESA = (PFNGLWINDOWPOS2DVMESAPROC)glad_glWindowPos2dvARB;
  if (glad_glWindowPos2f == NULL && glad_glWindowPos2fARB != NULL)
    glad_glWindowPos2f = (PFNGLWINDOWPOS2FPROC)glad_glWindowPos2fARB;
  if (glad_glWindowPos2f == NULL && glad_glWindowPos2fMESA != NULL)
    glad_glWindowPos2f = (PFNGLWINDOWPOS2FPROC)glad_glWindowPos2fMESA;
  if (glad_glWindowPos2fARB == NULL && glad_glWindowPos2f != NULL)
    glad_glWindowPos2fARB = (PFNGLWINDOWPOS2FARBPROC)glad_glWindowPos2f;
  if (glad_glWindowPos2fARB == NULL && glad_glWindowPos2fMESA != NULL)
    glad_glWindowPos2fARB = (PFNGLWINDOWPOS2FARBPROC)glad_glWindowPos2fMESA;
  if (glad_glWindowPos2fMESA == NULL && glad_glWindowPos2f != NULL)
    glad_glWindowPos2fMESA = (PFNGLWINDOWPOS2FMESAPROC)glad_glWindowPos2f;
  if (glad_glWindowPos2fMESA == NULL && glad_glWindowPos2fARB != NULL)
    glad_glWindowPos2fMESA = (PFNGLWINDOWPOS2FMESAPROC)glad_glWindowPos2fARB;
  if (glad_glWindowPos2fv == NULL && glad_glWindowPos2fvARB != NULL)
    glad_glWindowPos2fv = (PFNGLWINDOWPOS2FVPROC)glad_glWindowPos2fvARB;
  if (glad_glWindowPos2fv == NULL && glad_glWindowPos2fvMESA != NULL)
    glad_glWindowPos2fv = (PFNGLWINDOWPOS2FVPROC)glad_glWindowPos2fvMESA;
  if (glad_glWindowPos2fvARB == NULL && glad_glWindowPos2fv != NULL)
    glad_glWindowPos2fvARB = (PFNGLWINDOWPOS2FVARBPROC)glad_glWindowPos2fv;
  if (glad_glWindowPos2fvARB == NULL && glad_glWindowPos2fvMESA != NULL)
    glad_glWindowPos2fvARB = (PFNGLWINDOWPOS2FVARBPROC)glad_glWindowPos2fvMESA;
  if (glad_glWindowPos2fvMESA == NULL && glad_glWindowPos2fv != NULL)
    glad_glWindowPos2fvMESA = (PFNGLWINDOWPOS2FVMESAPROC)glad_glWindowPos2fv;
  if (glad_glWindowPos2fvMESA == NULL && glad_glWindowPos2fvARB != NULL)
    glad_glWindowPos2fvMESA = (PFNGLWINDOWPOS2FVMESAPROC)glad_glWindowPos2fvARB;
  if (glad_glWindowPos2i == NULL && glad_glWindowPos2iARB != NULL)
    glad_glWindowPos2i = (PFNGLWINDOWPOS2IPROC)glad_glWindowPos2iARB;
  if (glad_glWindowPos2i == NULL && glad_glWindowPos2iMESA != NULL)
    glad_glWindowPos2i = (PFNGLWINDOWPOS2IPROC)glad_glWindowPos2iMESA;
  if (glad_glWindowPos2iARB == NULL && glad_glWindowPos2i != NULL)
    glad_glWindowPos2iARB = (PFNGLWINDOWPOS2IARBPROC)glad_glWindowPos2i;
  if (glad_glWindowPos2iARB == NULL && glad_glWindowPos2iMESA != NULL)
    glad_glWindowPos2iARB = (PFNGLWINDOWPOS2IARBPROC)glad_glWindowPos2iMESA;
  if (glad_glWindowPos2iMESA == NULL && glad_glWindowPos2i != NULL)
    glad_glWindowPos2iMESA = (PFNGLWINDOWPOS2IMESAPROC)glad_glWindowPos2i;
  if (glad_glWindowPos2iMESA == NULL && glad_glWindowPos2iARB != NULL)
    glad_glWindowPos2iMESA = (PFNGLWINDOWPOS2IMESAPROC)glad_glWindowPos2iARB;
  if (glad_glWindowPos2iv == NULL && glad_glWindowPos2ivARB != NULL)
    glad_glWindowPos2iv = (PFNGLWINDOWPOS2IVPROC)glad_glWindowPos2ivARB;
  if (glad_glWindowPos2iv == NULL && glad_glWindowPos2ivMESA != NULL)
    glad_glWindowPos2iv = (PFNGLWINDOWPOS2IVPROC)glad_glWindowPos2ivMESA;
  if (glad_glWindowPos2ivARB == NULL && glad_glWindowPos2iv != NULL)
    glad_glWindowPos2ivARB = (PFNGLWINDOWPOS2IVARBPROC)glad_glWindowPos2iv;
  if (glad_glWindowPos2ivARB == NULL && glad_glWindowPos2ivMESA != NULL)
    glad_glWindowPos2ivARB = (PFNGLWINDOWPOS2IVARBPROC)glad_glWindowPos2ivMESA;
  if (glad_glWindowPos2ivMESA == NULL && glad_glWindowPos2iv != NULL)
    glad_glWindowPos2ivMESA = (PFNGLWINDOWPOS2IVMESAPROC)glad_glWindowPos2iv;
  if (glad_glWindowPos2ivMESA == NULL && glad_glWindowPos2ivARB != NULL)
    glad_glWindowPos2ivMESA = (PFNGLWINDOWPOS2IVMESAPROC)glad_glWindowPos2ivARB;
  if (glad_glWindowPos2s == NULL && glad_glWindowPos2sARB != NULL)
    glad_glWindowPos2s = (PFNGLWINDOWPOS2SPROC)glad_glWindowPos2sARB;
  if (glad_glWindowPos2s == NULL && glad_glWindowPos2sMESA != NULL)
    glad_glWindowPos2s = (PFNGLWINDOWPOS2SPROC)glad_glWindowPos2sMESA;
  if (glad_glWindowPos2sARB == NULL && glad_glWindowPos2s != NULL)
    glad_glWindowPos2sARB = (PFNGLWINDOWPOS2SARBPROC)glad_glWindowPos2s;
  if (glad_glWindowPos2sARB == NULL && glad_glWindowPos2sMESA != NULL)
    glad_glWindowPos2sARB = (PFNGLWINDOWPOS2SARBPROC)glad_glWindowPos2sMESA;
  if (glad_glWindowPos2sMESA == NULL && glad_glWindowPos2s != NULL)
    glad_glWindowPos2sMESA = (PFNGLWINDOWPOS2SMESAPROC)glad_glWindowPos2s;
  if (glad_glWindowPos2sMESA == NULL && glad_glWindowPos2sARB != NULL)
    glad_glWindowPos2sMESA = (PFNGLWINDOWPOS2SMESAPROC)glad_glWindowPos2sARB;
  if (glad_glWindowPos2sv == NULL && glad_glWindowPos2svARB != NULL)
    glad_glWindowPos2sv = (PFNGLWINDOWPOS2SVPROC)glad_glWindowPos2svARB;
  if (glad_glWindowPos2sv == NULL && glad_glWindowPos2svMESA != NULL)
    glad_glWindowPos2sv = (PFNGLWINDOWPOS2SVPROC)glad_glWindowPos2svMESA;
  if (glad_glWindowPos2svARB == NULL && glad_glWindowPos2sv != NULL)
    glad_glWindowPos2svARB = (PFNGLWINDOWPOS2SVARBPROC)glad_glWindowPos2sv;
  if (glad_glWindowPos2svARB == NULL && glad_glWindowPos2svMESA != NULL)
    glad_glWindowPos2svARB = (PFNGLWINDOWPOS2SVARBPROC)glad_glWindowPos2svMESA;
  if (glad_glWindowPos2svMESA == NULL && glad_glWindowPos2sv != NULL)
    glad_glWindowPos2svMESA = (PFNGLWINDOWPOS2SVMESAPROC)glad_glWindowPos2sv;
  if (glad_glWindowPos2svMESA == NULL && glad_glWindowPos2svARB != NULL)
    glad_glWindowPos2svMESA = (PFNGLWINDOWPOS2SVMESAPROC)glad_glWindowPos2svARB;
  if (glad_glWindowPos3d == NULL && glad_glWindowPos3dARB != NULL)
    glad_glWindowPos3d = (PFNGLWINDOWPOS3DPROC)glad_glWindowPos3dARB;
  if (glad_glWindowPos3d == NULL && glad_glWindowPos3dMESA != NULL)
    glad_glWindowPos3d = (PFNGLWINDOWPOS3DPROC)glad_glWindowPos3dMESA;
  if (glad_glWindowPos3dARB == NULL && glad_glWindowPos3d != NULL)
    glad_glWindowPos3dARB = (PFNGLWINDOWPOS3DARBPROC)glad_glWindowPos3d;
  if (glad_glWindowPos3dARB == NULL && glad_glWindowPos3dMESA != NULL)
    glad_glWindowPos3dARB = (PFNGLWINDOWPOS3DARBPROC)glad_glWindowPos3dMESA;
  if (glad_glWindowPos3dMESA == NULL && glad_glWindowPos3d != NULL)
    glad_glWindowPos3dMESA = (PFNGLWINDOWPOS3DMESAPROC)glad_glWindowPos3d;
  if (glad_glWindowPos3dMESA == NULL && glad_glWindowPos3dARB != NULL)
    glad_glWindowPos3dMESA = (PFNGLWINDOWPOS3DMESAPROC)glad_glWindowPos3dARB;
  if (glad_glWindowPos3dv == NULL && glad_glWindowPos3dvARB != NULL)
    glad_glWindowPos3dv = (PFNGLWINDOWPOS3DVPROC)glad_glWindowPos3dvARB;
  if (glad_glWindowPos3dv == NULL && glad_glWindowPos3dvMESA != NULL)
    glad_glWindowPos3dv = (PFNGLWINDOWPOS3DVPROC)glad_glWindowPos3dvMESA;
  if (glad_glWindowPos3dvARB == NULL && glad_glWindowPos3dv != NULL)
    glad_glWindowPos3dvARB = (PFNGLWINDOWPOS3DVARBPROC)glad_glWindowPos3dv;
  if (glad_glWindowPos3dvARB == NULL && glad_glWindowPos3dvMESA != NULL)
    glad_glWindowPos3dvARB = (PFNGLWINDOWPOS3DVARBPROC)glad_glWindowPos3dvMESA;
  if (glad_glWindowPos3dvMESA == NULL && glad_glWindowPos3dv != NULL)
    glad_glWindowPos3dvMESA = (PFNGLWINDOWPOS3DVMESAPROC)glad_glWindowPos3dv;
  if (glad_glWindowPos3dvMESA == NULL && glad_glWindowPos3dvARB != NULL)
    glad_glWindowPos3dvMESA = (PFNGLWINDOWPOS3DVMESAPROC)glad_glWindowPos3dvARB;
  if (glad_glWindowPos3f == NULL && glad_glWindowPos3fARB != NULL)
    glad_glWindowPos3f = (PFNGLWINDOWPOS3FPROC)glad_glWindowPos3fARB;
  if (glad_glWindowPos3f == NULL && glad_glWindowPos3fMESA != NULL)
    glad_glWindowPos3f = (PFNGLWINDOWPOS3FPROC)glad_glWindowPos3fMESA;
  if (glad_glWindowPos3fARB == NULL && glad_glWindowPos3f != NULL)
    glad_glWindowPos3fARB = (PFNGLWINDOWPOS3FARBPROC)glad_glWindowPos3f;
  if (glad_glWindowPos3fARB == NULL && glad_glWindowPos3fMESA != NULL)
    glad_glWindowPos3fARB = (PFNGLWINDOWPOS3FARBPROC)glad_glWindowPos3fMESA;
  if (glad_glWindowPos3fMESA == NULL && glad_glWindowPos3f != NULL)
    glad_glWindowPos3fMESA = (PFNGLWINDOWPOS3FMESAPROC)glad_glWindowPos3f;
  if (glad_glWindowPos3fMESA == NULL && glad_glWindowPos3fARB != NULL)
    glad_glWindowPos3fMESA = (PFNGLWINDOWPOS3FMESAPROC)glad_glWindowPos3fARB;
  if (glad_glWindowPos3fv == NULL && glad_glWindowPos3fvARB != NULL)
    glad_glWindowPos3fv = (PFNGLWINDOWPOS3FVPROC)glad_glWindowPos3fvARB;
  if (glad_glWindowPos3fv == NULL && glad_glWindowPos3fvMESA != NULL)
    glad_glWindowPos3fv = (PFNGLWINDOWPOS3FVPROC)glad_glWindowPos3fvMESA;
  if (glad_glWindowPos3fvARB == NULL && glad_glWindowPos3fv != NULL)
    glad_glWindowPos3fvARB = (PFNGLWINDOWPOS3FVARBPROC)glad_glWindowPos3fv;
  if (glad_glWindowPos3fvARB == NULL && glad_glWindowPos3fvMESA != NULL)
    glad_glWindowPos3fvARB = (PFNGLWINDOWPOS3FVARBPROC)glad_glWindowPos3fvMESA;
  if (glad_glWindowPos3fvMESA == NULL && glad_glWindowPos3fv != NULL)
    glad_glWindowPos3fvMESA = (PFNGLWINDOWPOS3FVMESAPROC)glad_glWindowPos3fv;
  if (glad_glWindowPos3fvMESA == NULL && glad_glWindowPos3fvARB != NULL)
    glad_glWindowPos3fvMESA = (PFNGLWINDOWPOS3FVMESAPROC)glad_glWindowPos3fvARB;
  if (glad_glWindowPos3i == NULL && glad_glWindowPos3iARB != NULL)
    glad_glWindowPos3i = (PFNGLWINDOWPOS3IPROC)glad_glWindowPos3iARB;
  if (glad_glWindowPos3i == NULL && glad_glWindowPos3iMESA != NULL)
    glad_glWindowPos3i = (PFNGLWINDOWPOS3IPROC)glad_glWindowPos3iMESA;
  if (glad_glWindowPos3iARB == NULL && glad_glWindowPos3i != NULL)
    glad_glWindowPos3iARB = (PFNGLWINDOWPOS3IARBPROC)glad_glWindowPos3i;
  if (glad_glWindowPos3iARB == NULL && glad_glWindowPos3iMESA != NULL)
    glad_glWindowPos3iARB = (PFNGLWINDOWPOS3IARBPROC)glad_glWindowPos3iMESA;
  if (glad_glWindowPos3iMESA == NULL && glad_glWindowPos3i != NULL)
    glad_glWindowPos3iMESA = (PFNGLWINDOWPOS3IMESAPROC)glad_glWindowPos3i;
  if (glad_glWindowPos3iMESA == NULL && glad_glWindowPos3iARB != NULL)
    glad_glWindowPos3iMESA = (PFNGLWINDOWPOS3IMESAPROC)glad_glWindowPos3iARB;
  if (glad_glWindowPos3iv == NULL && glad_glWindowPos3ivARB != NULL)
    glad_glWindowPos3iv = (PFNGLWINDOWPOS3IVPROC)glad_glWindowPos3ivARB;
  if (glad_glWindowPos3iv == NULL && glad_glWindowPos3ivMESA != NULL)
    glad_glWindowPos3iv = (PFNGLWINDOWPOS3IVPROC)glad_glWindowPos3ivMESA;
  if (glad_glWindowPos3ivARB == NULL && glad_glWindowPos3iv != NULL)
    glad_glWindowPos3ivARB = (PFNGLWINDOWPOS3IVARBPROC)glad_glWindowPos3iv;
  if (glad_glWindowPos3ivARB == NULL && glad_glWindowPos3ivMESA != NULL)
    glad_glWindowPos3ivARB = (PFNGLWINDOWPOS3IVARBPROC)glad_glWindowPos3ivMESA;
  if (glad_glWindowPos3ivMESA == NULL && glad_glWindowPos3iv != NULL)
    glad_glWindowPos3ivMESA = (PFNGLWINDOWPOS3IVMESAPROC)glad_glWindowPos3iv;
  if (glad_glWindowPos3ivMESA == NULL && glad_glWindowPos3ivARB != NULL)
    glad_glWindowPos3ivMESA = (PFNGLWINDOWPOS3IVMESAPROC)glad_glWindowPos3ivARB;
  if (glad_glWindowPos3s == NULL && glad_glWindowPos3sARB != NULL)
    glad_glWindowPos3s = (PFNGLWINDOWPOS3SPROC)glad_glWindowPos3sARB;
  if (glad_glWindowPos3s == NULL && glad_glWindowPos3sMESA != NULL)
    glad_glWindowPos3s = (PFNGLWINDOWPOS3SPROC)glad_glWindowPos3sMESA;
  if (glad_glWindowPos3sARB == NULL && glad_glWindowPos3s != NULL)
    glad_glWindowPos3sARB = (PFNGLWINDOWPOS3SARBPROC)glad_glWindowPos3s;
  if (glad_glWindowPos3sARB == NULL && glad_glWindowPos3sMESA != NULL)
    glad_glWindowPos3sARB = (PFNGLWINDOWPOS3SARBPROC)glad_glWindowPos3sMESA;
  if (glad_glWindowPos3sMESA == NULL && glad_glWindowPos3s != NULL)
    glad_glWindowPos3sMESA = (PFNGLWINDOWPOS3SMESAPROC)glad_glWindowPos3s;
  if (glad_glWindowPos3sMESA == NULL && glad_glWindowPos3sARB != NULL)
    glad_glWindowPos3sMESA = (PFNGLWINDOWPOS3SMESAPROC)glad_glWindowPos3sARB;
  if (glad_glWindowPos3sv == NULL && glad_glWindowPos3svARB != NULL)
    glad_glWindowPos3sv = (PFNGLWINDOWPOS3SVPROC)glad_glWindowPos3svARB;
  if (glad_glWindowPos3sv == NULL && glad_glWindowPos3svMESA != NULL)
    glad_glWindowPos3sv = (PFNGLWINDOWPOS3SVPROC)glad_glWindowPos3svMESA;
  if (glad_glWindowPos3svARB == NULL && glad_glWindowPos3sv != NULL)
    glad_glWindowPos3svARB = (PFNGLWINDOWPOS3SVARBPROC)glad_glWindowPos3sv;
  if (glad_glWindowPos3svARB == NULL && glad_glWindowPos3svMESA != NULL)
    glad_glWindowPos3svARB = (PFNGLWINDOWPOS3SVARBPROC)glad_glWindowPos3svMESA;
  if (glad_glWindowPos3svMESA == NULL && glad_glWindowPos3sv != NULL)
    glad_glWindowPos3svMESA = (PFNGLWINDOWPOS3SVMESAPROC)glad_glWindowPos3sv;
  if (glad_glWindowPos3svMESA == NULL && glad_glWindowPos3svARB != NULL)
    glad_glWindowPos3svMESA = (PFNGLWINDOWPOS3SVMESAPROC)glad_glWindowPos3svARB;
}
...
static int glad_gl_find_extensions_gl(int version) {
  ...
  GLAD_GL_APPLE_fence = glad_gl_has_extension(version, exts, num_exts_i, exts_i,
                                              "GL_APPLE_fence");
  ...
  GLAD_GL_APPLE_row_bytes = glad_gl_has_extension(version, exts, num_exts_i,
                                                  exts_i, "GL_APPLE_row_bytes");
  ...
  GLAD_GL_APPLE_ycbcr_422 = glad_gl_has_extension(version, exts, num_exts_i,
                                                  exts_i, "GL_APPLE_ycbcr_422");
  ...
  GLAD_GL_ARB_imaging = glad_gl_has_extension(version, exts, num_exts_i, exts_i,
                                              "GL_ARB_imaging");
  ...
  GLAD_GL_ARB_shadow =
      glad_gl_has_extension(version, exts, num_exts_i, exts_i, "GL_ARB_shadow");
  ...
  GLAD_GL_ATI_meminfo = glad_gl_has_extension(version, exts, num_exts_i, exts_i,
                                              "GL_ATI_meminfo");
  ...
  GLAD_GL_EXT_blend_color = glad_gl_has_extension(version, exts, num_exts_i,
                                                  exts_i, "GL_EXT_blend_color");
  ...
  GLAD_GL_EXT_cmyka =
      glad_gl_has_extension(version, exts, num_exts_i, exts_i, "GL_EXT_cmyka");
  ...
  GLAD_GL_EXT_convolution = glad_gl_has_extension(version, exts, num_exts_i,
                                                  exts_i, "GL_EXT_convolution");
  ...
  GLAD_GL_EXT_cull_vertex = glad_gl_has_extension(version, exts, num_exts_i,
                                                  exts_i, "GL_EXT_cull_vertex");
  GLAD_GL_EXT_debug_label = glad_gl_has_extension(version, exts, num_exts_i,
                                                  exts_i, "GL_EXT_debug_label");
  ...
  GLAD_GL_EXT_framebuffer_blit_layers = glad_gl_has_extension(
      version, exts, num_exts_i, exts_i, "GL_EXT_framebuffer_blit_layers");
  ...
  GLAD_GL_EXT_gpu_shader4 = glad_gl_has_extension(version, exts, num_exts_i,
                                                  exts_i, "GL_EXT_gpu_shader4");
  ...
  GLAD_GL_EXT_multisample = glad_gl_has_extension(version, exts, num_exts_i,
                                                  exts_i, "GL_EXT_multisample");
  ...
  GLAD_GL_EXT_texture = glad_gl_has_extension(version, exts, num_exts_i, exts_i,
                                              "GL_EXT_texture");
  ...
  GLAD_GL_EXT_timer_query = glad_gl_has_extension(version, exts, num_exts_i,
                                                  exts_i, "GL_EXT_timer_query");
  ...
  GLAD_GL_IBM_cull_vertex = glad_gl_has_extension(version, exts, num_exts_i,
                                                  exts_i, "GL_IBM_cull_vertex");
  ...
  GLAD_GL_IBM_static_data = glad_gl_has_extension(version, exts, num_exts_i,
                                                  exts_i, "GL_IBM_static_data");
  ...
  GLAD_GL_MESA_window_pos = glad_gl_has_extension(version, exts, num_exts_i,
                                                  exts_i, "GL_MESA_window_pos");
  ...
  GLAD_GL_NV_blend_square = glad_gl_has_extension(version, exts, num_exts_i,
                                                  exts_i, "GL_NV_blend_square");
  GLAD_GL_NV_clip_space_w_scaling = glad_gl_has_extension(
      version, exts, num_exts_i, exts_i, "GL_NV_clip_space_w_scaling");
  GLAD_GL_NV_command_list = glad_gl_has_extension(version, exts, num_exts_i,
                                                  exts_i, "GL_NV_command_list");
  ...
  GLAD_GL_NV_draw_texture = glad_gl_has_extension(version, exts, num_exts_i,
                                                  exts_i, "GL_NV_draw_texture");
  ...
  GLAD_GL_NV_float_buffer = glad_gl_has_extension(version, exts, num_exts_i,
                                                  exts_i, "GL_NV_float_buffer");
  GLAD_GL_NV_fog_distance = glad_gl_has_extension(version, exts, num_exts_i,
                                                  exts_i, "GL_NV_fog_distance");
  ...
  GLAD_GL_NV_gpu_program4 = glad_gl_has_extension(version, exts, num_exts_i,
                                                  exts_i, "GL_NV_gpu_program4");
  GLAD_GL_NV_gpu_program5 = glad_gl_has_extension(version, exts, num_exts_i,
                                                  exts_i, "GL_NV_gpu_program5");
  ...
  GLAD_GL_NV_point_sprite = glad_gl_has_extension(version, exts, num_exts_i,
                                                  exts_i, "GL_NV_point_sprite");
  ...
  GLAD_GL_NV_uniform_buffer_std430_layout = glad_gl_has_extension(
      version, exts, num_exts_i, exts_i, "GL_NV_uniform_buffer_std430_layout");
  ...
  GLAD_GL_OES_read_format = glad_gl_has_extension(version, exts, num_exts_i,
                                                  exts_i, "GL_OES_read_format");
  ...
  GLAD_GL_SGIX_async =
      glad_gl_has_extension(version, exts, num_exts_i, exts_i, "GL_SGIX_async");
  ...
  GLAD_GL_SGIX_fog_offset = glad_gl_has_extension(version, exts, num_exts_i,
                                                  exts_i, "GL_SGIX_fog_offset");
  ...
  GLAD_GL_SGIX_shadow = glad_gl_has_extension(version, exts, num_exts_i, exts_i,
                                              "GL_SGIX_shadow");
  GLAD_GL_SGIX_shadow_ambient = glad_gl_has_extension(
      version, exts, num_exts_i, exts_i, "GL_SGIX_shadow_ambient");
  GLAD_GL_SGIX_sprite = glad_gl_has_extension(version, exts, num_exts_i, exts_i,
                                              "GL_SGIX_sprite");
  ...
  GLAD_GL_SGIX_ycrcb =
      glad_gl_has_extension(version, exts, num_exts_i, exts_i, "GL_SGIX_ycrcb");
  GLAD_GL_SGIX_ycrcb_subsample = glad_gl_has_extension(
      version, exts, num_exts_i, exts_i, "GL_SGIX_ycrcb_subsample");
  GLAD_GL_SGIX_ycrcba = glad_gl_has_extension(version, exts, num_exts_i, exts_i,
                                              "GL_SGIX_ycrcba");
  GLAD_GL_SGI_color_matrix = glad_gl_has_extension(
      version, exts, num_exts_i, exts_i, "GL_SGI_color_matrix");
  GLAD_GL_SGI_color_table = glad_gl_has_extension(version, exts, num_exts_i,
                                                  exts_i, "GL_SGI_color_table");
  ...
  GLAD_GL_SUN_slice_accum = glad_gl_has_extension(version, exts, num_exts_i,
                                                  exts_i, "GL_SUN_slice_accum");
  GLAD_GL_SUN_triangle_list = glad_gl_has_extension(
      version, exts, num_exts_i, exts_i, "GL_SUN_triangle_list");
  GLAD_GL_SUN_vertex =
      glad_gl_has_extension(version, exts, num_exts_i, exts_i, "GL_SUN_vertex");
